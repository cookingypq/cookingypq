...
function Calendar({ className, classNames, font, ...props }: CalendarProps) {
  return (
    <div
      className={cn(
        "bg-black relative border-4 border-gray-600 w-max p-4",
        className
      )}
    >
      <ShadcnCalendar
        ...
        classNames={{
          nav_button: cn(
            ...
            "size-8 bg-black p-0 flex items-center justify-center hover:bg-gray-800 border-2 border-gray-600 text-white"
          ),
          day_button: cn(
            buttonVariants({ variant: "ghost" }),
            "h-10 w-10 font-normal text-white hover:bg-gray-800 aria-selected:bg-white aria-selected:text-black"
          ),
          day: cn(
            "relative w-full h-full p-0 text-center [&:first-child[data-selected=true]_button]:rounded-none [&:last-child[data-selected=true]_button]:rounded-none group/day select-none"
          ),
          caption_label: "text-sm font-medium text-white",
          head_cell: "text-white text-xs font-medium",
          ...classNames,
        }}
        components={{
